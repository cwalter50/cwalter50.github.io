...
- [HotProspects](https://github.com/cwalter50/NeverForgetNames): Project 16 in 100 Days SwiftUI. Days 79-85. Lists, QrCode scanner and Reader, Swift Package Dependencies, User Notifications, UserDefaults, TabView, Result, image interpolation, Context Menus. A great app that allows the user to add contacts via QR code, then mark them as contacted or uncontacted. Great idea for conventions or meetups.
